...
class RegisterView(CreateAPIView):
    ...
    def perform_create(self, serializer):
        ...
        try:
            if UserCompany.objects.get(email=user.email):
                my_user = UserCompany.objects.get(email=user.email)
                my_user.user = AuthUser.objects.get(email=user.email)
                my_user.save()

                new_user = AuthUser.objects.get(id=user.id)
                new_user.first_name = my_user.first_name
                new_user.last_name =  my_user.last_name
                new_user.save()
